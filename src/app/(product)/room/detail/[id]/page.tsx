...
import RoomDetailSlide from '@/app/(product)/(roomComponent)/(detail)/RoomDetailSlide'
import RoomDetailLoading from '@/app/(product)/(roomComponent)/(detail)/RoomDetailLoading'
